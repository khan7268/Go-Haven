  ...
  return (
    <div className="w-full shadow-md bg-white">
      <header className="flex flex-col sm:flex-row items-center justify-between gap-3 px-4 py-3 md:px-8">
        ...
        {/* Search bar (Center) */}
        <div className="flex-grow max-w-xl w-full flex justify-center">
          <div className="flex gap-2 items-center border border-gray-300 rounded-full py-2 px-4 shadow-md shadow-gray-300 text-sm w-full sm:w-auto">
            <div>Anywhere</div>
